...
if (!userId || userId === "0") {
  console.error("❌ Invalid or missing userId from localStorage");
  return;
}
        ...
        if (profileData && profileData.jobSeekerProfile) {
          setUserInfo({
            firstName: profileData.jobSeekerProfile.firstName || "",
            lastName: profileData.jobSeekerProfile.lastName || "",
            email: profileData.email || "",
            phone: profileData.jobSeekerProfile.phoneNumber || "",
            location: profileData.jobSeekerProfile.location || "Not specified",
            bio: profileData.jobSeekerProfile.bio || ""
          });
        }
      } catch (error) {
